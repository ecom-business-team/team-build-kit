...
| **Project** | The work that reaches one milestone, or a standalone build: one memo, one PRD, one build, one ship, one outcome check. While it is in flight it lives in `_admin/prds/<project>/`. |
